...
export class BandService {
    ...
    constructor(private musicians: Musician[], private theory: Theory) { }
    ...
    private createScheduleLoop() {
        ...
        for (i = 0; i < numChoruses * chorusLength; i = i + chorusLength) {
            // lady bird
            song.addMeasure(new Measure(1 + i, self.style, [this.theory.getChord('C', 'maj7'), this.theory.getChord('C', 'maj7'), this.theory.getChord('C', 'maj7'), this.theory.getChord('C', 'maj7')], 4));
            song.addMeasure(new Measure(2 + i, self.style, [this.theory.getChord('C', 'maj7'), this.theory.getChord('C', 'maj7'), this.theory.getChord('C', 'maj7'), this.theory.getChord('C', 'maj7')], 4));
            song.addMeasure(new Measure(3 + i, self.style, [this.theory.getChord('F', 'min7'), this.theory.getChord('F', 'min7'), this.theory.getChord('F', 'min7'), this.theory.getChord('F', 'min7')], 4));
            song.addMeasure(new Measure(4 + i, self.style, [this.theory.getChord('Bb', '7'), this.theory.getChord('Bb', '7'), this.theory.getChord('Bb', '7'), this.theory.getChord('Bb', '7')], 4));
            song.addMeasure(new Measure(5 + i, self.style, [this.theory.getChord('C', 'maj7'), this.theory.getChord('C', 'maj7'), this.theory.getChord('C', 'maj7'), this.theory.getChord('C', 'maj7')], 4));
            song.addMeasure(new Measure(6 + i, self.style, [this.theory.getChord('C', 'maj7'), this.theory.getChord('C', 'maj7'), this.theory.getChord('C', 'maj7'), this.theory.getChord('C', 'maj7')], 4));
            ...
            song.addMeasure(new Measure(10 + i, self.style, [this.theory.getChord('Ab', 'maj7'), this.theory.getChord('Ab', 'maj7'), this.theory.getChord('Ab', 'maj7'), this.theory.getChord('Ab', 'maj7')], 4));
            song.addMeasure(new Measure(11 + i, self.style, [this.theory.getChord('G', 'maj7'), this.theory.getChord('G', 'maj7'), this.theory.getChord('G', 'maj7'), this.theory.getChord('G', 'maj7')], 4));
            song.addMeasure(new Measure(12 + i, self.style, [this.theory.getChord('G', 'maj7'), this.theory.getChord('G', 'maj7'), this.theory.getChord('G', 'maj7'), this.theory.getChord('G', 'maj7')], 4));
            song.addMeasure(new Measure(13 + i, self.style, [this.theory.getChord('D', 'min7'), this.theory.getChord('D', 'min7'), this.theory.getChord('D', 'min7'), this.theory.getChord('D', 'min7')], 4));
            song.addMeasure(new Measure(14 + i, self.style, [this.theory.getChord('G', '7'), this.theory.getChord('G', '7'), this.theory.getChord('G', '7'), this.theory.getChord('G', '7')], 4));
            song.addMeasure(new Measure(15 + i, self.style, [this.theory.getChord('C', 'maj7'), this.theory.getChord('C', 'maj7'), this.theory.getChord('Eb', 'maj7'), this.theory.getChord('Eb', 'maj7')], 4));
            song.addMeasure(new Measure(16 + i, self.style, [this.theory.getChord('Ab', 'maj7'), this.theory.getChord('Ab', 'maj7'), this.theory.getChord('Db', 'maj7'), this.theory.getChord('Db', 'maj7')], 4));
